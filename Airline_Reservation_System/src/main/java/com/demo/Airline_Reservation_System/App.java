...
//        int customerId = 7; // Assuming customerId is an integer
...
//        int bookingDate = 20230920; // Example booking date as an integer (e.g., YYYYMMDD)
//        String bookingStatus = "Confirmed";
//        String toLocation = "New York";
//        String fromLocation = "Mumbai";
//
//        Booking booking1 = new Booking(bookingId, bookingDate, bookingStatus, toLocation, fromLocation);
//        
//        // Create a new Airline
//        int airLineId = 4; // Example airline ID
...
//        int paymentId = 5; // Example payment ID
...
//        
//        // Create a new Ticket
//        int ticketId = 6; // Example ticket ID
